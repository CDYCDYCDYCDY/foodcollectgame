...
# 新增储存系统配置
STORE_DURATIONS = [0, 0.5, 1.0, 1.5, 2.0, 2.5] # 各负重对应的储存时间(秒)，索引对应负重值
STORE_SCORES = [0, 10, 20, 30, 40, 50]           # 各负重对应的积分，索引对应负重值
...
# 道具系统配置
ITEM_FALL_SPEED_RANGE = (3, 4)  # 道具下落速度范围 (最小值, 最大值)
ITEM_SPAWN_INTERVAL_RANGE = (500, 1000)  # 道具生成间隔范围 (毫秒)
...
# 炸弹配置
BOMB_STUN_DURATION = 2  # 炸弹眩晕持续时间(秒)
# 时钟道具配置
CLOCK_ADD_TIME = 3  # 时钟道具增加的时间(秒)
